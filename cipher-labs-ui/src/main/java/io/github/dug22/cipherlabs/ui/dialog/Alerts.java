...
public enum Alerts {
    ...
    POLYBIUS_KEY_ERROR(new AlertBuilder.Builder()
            .setAlertType(Alert.AlertType.ERROR)
            .setTitle("Input Key Error")
            .setHeaderText("Input Key Error")
    ...
    PORTA_KEY_ERROR(new AlertBuilder.Builder()
            .setAlertType(Alert.AlertType.ERROR)
            .setTitle("Key Input Error")
            .setHeaderText("Key Input Error")
            .setContentText("An error has occurred! Please make sure that the key is less than or equal to the length of your message and that your key only contains alphabetic characters!")
    ...
    RAILFENCE_RAIL_AMOUNT_ERROR(new AlertBuilder.Builder()
            .setAlertType(Alert.AlertType.ERROR)
            .setTitle("Rail Amount Error")
            .setHeaderText("Rail Amount Error")
            .setContentText("Rails cannot be greater than the given plaintext/ciphertext length")
            .setImageView(getErrorLogo(), 64, 64)
            .build()),
