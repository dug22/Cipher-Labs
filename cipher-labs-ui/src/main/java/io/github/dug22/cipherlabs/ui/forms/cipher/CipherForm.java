...
public abstract class CipherForm extends AbstractForm<String> {
    ...
    protected void initEncryptDecryptAction(Cipher cipher, String key, boolean encrypt, String tabTitle) {
        CipherFormActions.initEncryptDecryptAction(cipher, workStationController, tabPane, key, encrypt, tabTitle);
    }
}
