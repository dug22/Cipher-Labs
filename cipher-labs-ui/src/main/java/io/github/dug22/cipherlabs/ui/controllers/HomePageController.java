...
public class HomePageController extends AbstractController {
    ...
    protected void defineControlListeners() {
        ...
        Stream.of(lockSpotLabel, lockSpotCard).forEach(control -> control.setOnMouseClicked((_) -> new SceneLoaderTask("fxml/lock-spot-page.fxml", new StageProperties("Lock Spot Page")).run()));
        Stream.of(resourcesLabel, resourcesCard).forEach(control -> control.setOnMouseClicked((_) -> new SceneLoaderTask("fxml/resource-page.fxml", new StageProperties("Cipher Labs Resources")).run()));
    ...
    private void showFileChooser() {
        ...
        if (selectedFile != null) {
            ...
            new SceneLoaderTask("fxml/work-station.fxml", new StageProperties("Cipher Labs Workstation " + selectedFile.getName())).run();
        }
    }
