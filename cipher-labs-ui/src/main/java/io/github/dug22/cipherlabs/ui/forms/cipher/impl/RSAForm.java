...
public class RSAForm extends CipherForm {
    ...
    protected void initOptions() {
        ...
        centeredBottomBorderPane.addCenteredContent(nBitLength);
    ...
    protected void initListeners() {
        getEncryptButton().setOnAction((_) -> {
            ...
            if (isPrime() && isInvertible()) {
                initEncryptDecryptAction(rsa, p + " " + q + " " + exponent, true, "RSA Encrypted Result");
            } else {
        ...
        getDecryptButton().setOnAction((_) -> {
            ...
            if (isPrime() && isInvertible()) {
                initEncryptDecryptAction(rsa,p + " " + q + " " + exponent, false, "RSA Decrypted Result");
            } else {
                Alerts.RSA_KEY_ERROR.show();
            }
        });
