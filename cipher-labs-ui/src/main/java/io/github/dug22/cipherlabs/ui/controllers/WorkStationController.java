...
public class WorkStationController extends AbstractController {
    ...
    protected void defineNavigationHeader() {
        Menu fileMenu = new MenuBuilder.Builder().createMenu("File")
                .addMenuItem("Home", new SceneLoaderTask("fxml/home-page.fxml", new StageProperties("Cipher Labs Home Page")))
                .addMenuItem("Lock Spot", new SceneLoaderTask("fxml/lock-spot-page.fxml", new StageProperties("Lock Spot Page")))
        ...
        Menu encryptDecryptMenu = new MenuBuilder.Builder().createMenu("Encrypt/Decrypt")
                .addSubMenu(new MenuBuilder.Builder()
                        ...
                        .addMenuItem("Affine", new OpenAffineCipherFormTask(this, tabPane))
                        .addMenuItem("Atbash", new OpenAtbashCipherFormTask(this, tabPane))
                        ...
                        .addMenuItem("Polybius", new OpenPolybiusCipherFormTask(this, tabPane))
                        .addMenuItem("Porta", new OpenPortaCipherFormTask(this, tabPane))
                        .addMenuItem("Rail Fence", new OpenRailFenceCipherFormTask(this, tabPane))
        ...
        Menu helpMenu = new MenuBuilder.Builder().createMenu("Help")
                .addMenuItem("Resources", new SceneLoaderTask("fxml/resource-page.fxml", new StageProperties("Cipher Labs Resources")))
    ...
    public ScrollPane createAnalysisDashboard(TextArea textArea, boolean isOriginalDocument) {
        ...
        VBox uniqueCharactersCard = createMetricCard("Unique Characters", String.valueOf(TextUtils.getUniqueCharacterCount(textArea.getText())));
        VBox mostFrequentCharacterCard = createMetricCard("Most Frequent Character", String.valueOf(TextUtils.getMostFrequentCharacter(textArea.getText())));
        VBox hasDigitsCard = createMetricCard("Contains Digits?", TextUtils.hasDigits(textArea.getText()) == 1 ? "True" : "False");
        VBox hasDoubleLettersOrDoubleNumbersCard = createMetricCard("Has Double Letters or Double Numbers?", TextUtils.hasDoubleLettersOrNumbers(textArea.getText()) == 1 ? "True" : "False");
    ...
    public BarChart<String, Number> getFrequencyChart(TextArea textArea) {
        ...
        Map<Character, Double> frequencyMap = TextUtils.getFrequencies(cleanText);
