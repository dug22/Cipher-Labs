...
import io.github.dug22.cipherlabs.core.ciphers.algorithm.classic.symmetric.enigma.reflector.ReflectorA;
import io.github.dug22.cipherlabs.core.ciphers.algorithm.classic.symmetric.enigma.reflector.ReflectorB;
import io.github.dug22.cipherlabs.core.ciphers.algorithm.classic.symmetric.enigma.reflector.ReflectorC;
import io.github.dug22.cipherlabs.core.ciphers.algorithm.classic.symmetric.enigma.rotors.*;
...
public class EnigmaForm extends CipherForm {
    ...
    protected void initOptions() {
        ...
        centeredBottomBorderPane.addCenteredContent(plugboardHeaderLabel);
        centeredBottomBorderPane.addCenteredContent(plugboardTextfield);
        centeredBottomBorderPane.addCenteredContent(reflectorHeaderLabel);
        centeredBottomBorderPane.addCenteredContent(reflectorComboBox);
        centeredBottomBorderPane.addCenteredContent(ringHeaderLabel);
        centeredBottomBorderPane.addCenteredContent(ringSpinnerRow);
        centeredBottomBorderPane.addCenteredContent(rotorHeaderLabel);
        centeredBottomBorderPane.addCenteredContent(rotorOptionsRow);
        centeredBottomBorderPane.addCenteredContent(keyHeaderLabel);
        centeredBottomBorderPane.addCenteredContent(keyTextfield);
        centeredBottomBorderPane.addCenteredContent(traceTable);
    ...
    private void encryptDecrypt(boolean encrypt) {
        ...
        enigma = CipherRegistry.createEnigma(reflector, plugboard, keyboard, rotors);
    ...
    private void runTableAnimation(String text, int[] rings, String key) {
        ...
        Enigma animationEnigma = CipherRegistry.createEnigma(animReflector, animPlugboard, animKeyboard, animRotors);
