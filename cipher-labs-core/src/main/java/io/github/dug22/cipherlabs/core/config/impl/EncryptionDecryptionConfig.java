package io.github.dug22.cipherlabs.core.config.impl;

import io.github.dug22.cipherlabs.core.config.AbstractConfigFile;
...
public class EncryptionDecryptionConfig extends AbstractConfigFile {
    ...
    public void init() {
        ...
        if (configurationManager.isFileEmpty(encryptionDecryptionConfigFile)) {
            ...
            properties.add(Map.of("rail-fence-cipher-separator", "-"));
